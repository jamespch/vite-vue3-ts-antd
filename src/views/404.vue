...
<script lang="ts">
  ...
  export default defineComponent({
    setup() {
      const message = 'Sorry, the page you visited does not exist...'
  ...
  <div class="wscn-http404-container">
    <div class="wscn-http404">
      ...
      <div class="bullshit">
        ...
        <div class="bullshit__info">Vue All rights reserved
          <a style="color:#20a0ff" href="./Home.vue" target="_blank"></a>
        </div>
